...
// Load login pages (centered forms)
        ...
        <div class="login-container">
            ...
            <div class="login-box">
                <div class="login-card" style="display: flex; flex-direction: column; align-items: center;">
                    ...
                    <form onsubmit="handleLogin(event, 'admin')" style="width: 100%; max-width: 400px;">
                    ...
                    <div class="demo-credentials" style="width: 100%; max-width: 400px;">
        ...
        <div class="login-container">
            ...
            <div class="login-box">
                <div class="login-card" style="display: flex; flex-direction: column; align-items: center;">
                    ...
                    <form onsubmit="handleLogin(event, 'teacher')" style="width: 100%; max-width: 400px;">
                        <div class="form-group">
                            <label><i class="fas fa-school"></i> School Code</label>
        ...
        <div class="login-container">
            ...
            <div class="login-box">
                <div class="login-card" style="display: flex; flex-direction: column; align-items: center;">
                    ...
                    <form onsubmit="handleLogin(event, 'parent')" style="width: 100%; max-width: 400px;">
                        <div class="form-group">
        ...
        <div class="login-container">
            ...
            <div class="login-box">
                <div class="login-card" style="display: flex; flex-direction: column; align-items: center;">
                    ...
                    <form onsubmit="handleLogin(event, 'student')" style="width: 100%; max-width: 400px;">
                        <div class="form-group">
                            <label><i class="fas fa-school"></i> School Code</label>
        ...
        <div class="login-container">
            ...
            <div class="login-box">
                <div class="login-card" style="display: flex; flex-direction: column; align-items: center;">
                    ...
                    <form onsubmit="handleLogin(event, 'super')" style="width: 100%; max-width: 400px;">
                        <div class="form-group">
